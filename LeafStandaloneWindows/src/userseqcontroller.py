...
def main():
    ...
    parser.add_argument('-o', '--output', help='The name of the output directory to create. (Required type: %(type)s, default value: a directory called %(default)s in the current working directory).',
